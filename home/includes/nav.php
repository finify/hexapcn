    ...
    <div class="scrollbar-inner">
      ...
      <div class="sidenav-header  align-items-center">
        <a class="navbar-brand sidenav-toggler" data-action="sidenav-pin" data-target="#sidenav-main" href="javascript:void(0)">
          <img src="<?= $sitelogoblack ?>"  class="navbar-brand-img" alt="...">
        </a> 
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="index.php">
                ...
                <span class="nav-link-text text-black">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="deposit.php">
                <i class="ni ni-spaceship text-danger"></i>
                <span class="nav-link-text text-black">Deposit</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="invest.php">
                <i class="ni ni-money-coins text-danger"></i>
                <span class="nav-link-text text-black">Invest</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="earnings.php">
                <i class="ni ni-credit-card text-danger"></i>
                <span class="nav-link-text text-black">Earnings</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="withdraw.php">
                <i class="ni ni-credit-card text-danger"></i>
                <span class="nav-link-text text-black">Withdrawal</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="myorder.php">
                <i class="ni ni-cart text-danger"></i>
                <span class="nav-link-text text-black">Deposit Orders</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="incomeforecast.php">
                <i class="ni ni-building text-danger"></i>
                <span class="nav-link-text text-black">Income Forecast</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="referral.php">
                <i class="ni ni-building text-danger"></i>
                <span class="nav-link-text text-black">Referral</span>
              </a>
            </li>
          </ul>
          <!-- Divider -->
