...
$sql1 = mysqli_query($con, "SELECT * FROM `fx_earnings`");   //checking no of investments
      ...
      <div class="card">
        <div class="card-header bg-transparent">
          <div class="row align-items-center">
            <div class="col">
              <h5 class="h3 mb-0">All Earnings</h5>
            </div>
          </div>
        </div>
        <div class="card-body">
            ...
            <table class="table align-items-center table-dark">
              <thead class="thead-light">
                <tr>
                  ...
                  <th style="font-size: 15px;" scope="col">Amountearned</th>
